...
const Mail = () => {
  ...
  const params = useParams(); // comes from react router dom // use for fetching id from url
    ...
    >
      <div className="flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          <button class="hover:rounded-full hover:bg-gray-100">
